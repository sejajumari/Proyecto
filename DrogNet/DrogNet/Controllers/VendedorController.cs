...
namespace DrogNet.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendedorID,Nombre,Apellido,Documento,Celular,Direccion,CorreoElectronico,Contraseña")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorID,Nombre,Apellido,Documento,Celular,Direccion,CorreoElectronico,Contraseña")] Vendedor vendedor)
        {
